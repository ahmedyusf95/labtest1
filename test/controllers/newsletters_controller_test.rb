...
class NewslettersControllerTest < ActionController::TestCase
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post :create, newsletter: { date: @newsletter.date, description: @newsletter.description, title: @newsletter.title }
    end
  ...
  test "should update newsletter" do
    patch :update, id: @newsletter, newsletter: { date: @newsletter.date, description: @newsletter.description, title: @newsletter.title }
    assert_redirected_to newsletter_path(assigns(:newsletter))
  end
